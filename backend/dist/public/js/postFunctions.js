...
const formComment = (data) => {
    ...
    <div>
      <button class="${buttons.like.class}" id="${comment.author}-${comment.id}-like" onclick="${buttons.like.onclick}" >${commentButtonsImages[0]}${likes}</button>
      <button class="${buttons.dislike.class}" id="${comment.author}-${comment.id}-dislike" onclick="${buttons.dislike.onclick}" >${buttons.dislike.image}${dislikes}</button>
